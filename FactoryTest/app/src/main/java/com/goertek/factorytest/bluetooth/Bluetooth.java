package com.goertek.factorytest.bluetooth;
...
public class Bluetooth extends Activity implements OnClickListener {
	...
	// ׷��
	class Bluetooth4 implements Runnable {
		public void run() {
			init();
		}
	}
	...
	class Bluetooth2 implements Runnable {
		public void run() {
	...
	class Bluetooth1 extends Handler {
		public void handleMessage(Message paramMessage) {
			...
			BlueHandler localBlueHandler = mBlueHandler;
