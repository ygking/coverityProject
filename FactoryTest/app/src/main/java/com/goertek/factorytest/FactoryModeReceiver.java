...
public class FactoryModeReceiver extends BroadcastReceiver {
    ...
    private final String TAG = "FactoryModeReceiver";
    // process *#*#4628#*#*
    	...
    	try {
			if (intent.getAction().equals("android.provider.Telephony.SECRET_CODE")) {
				...
				if (uri.equals(engineerUri)) {
					...
					i.setComponent(
							new ComponentName("com.goertek.factorytest", "com.goertek.factorytest.FactoryMode"));
					i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
					Log.i(TAG, "Before start FM activity");
