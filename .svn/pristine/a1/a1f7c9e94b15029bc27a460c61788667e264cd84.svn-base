...
import com.goertek.factorytest.gps.GPSThread;
import com.goertek.factorytest.wifi.WiFiTools;
  ...
  class AllTest3 implements Runnable
{
 ...
 /* public void SdCardInit()
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
   ...
   // localIntent.setFlags(Intent.FLAG_ACTIVITY_FORWARD_RESULT );
    ...
    if (paramInt1 == 16)
    {
      ...
      {
        localIntent.setClassName(this, "com.goertek.factorytest.KeyCode");
        i = 512;
      }
    }
      ...
      if (paramInt1 == 512)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.lcd.LCD");
        i = 400;
      }
      if (paramInt1 == 400)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.led.Led");
        i = 404;
      }
      if (paramInt1 == 404)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.touchscreen.LineTest");
        i = 32;
      }
      if (paramInt1 == 32)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.backlight.BackLight");
        i = 256;
      }
      if (paramInt1 == 256)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.sdcard.SDCard");
        i = 384;
      }
      if (paramInt1 == 384)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.vibrator.Vibrator");
        i = 128;
      }
      if (paramInt1 == 128)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.signal.Signal");
        i = 144;
      }
      if (paramInt1 == 144)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.earphone.Earphone");
        i = 368;
      }
      if (paramInt1 == 368)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.microphone.MicRecorder");
        i = 514;
      }
      if (paramInt1 == 514)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.headset.HeadSet");
        i = 48;
      }
      if (paramInt1 == 48)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.audio.AudioTest");
        i = 288;
      }
      if (paramInt1 == 288)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.fmradio.FMRadio");
        i = 513;
      }
      if (paramInt1 == 513)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.sensor.GSensor");
        i = 304;
      }
      if (paramInt1 == 304)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.sensor.MSensor");
        i = 320;
      }
      if (paramInt1 == 320)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.sensor.PSensor");
        i = 352;
      }
      if (paramInt1 == 352)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.sensor.LSensor");
        i = 336;
      }
      if (paramInt1 == 336)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.simcard.SimCard");
        i = 515;
      }
      if (paramInt1 == 515)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.camera.SubCamera");
        i = 516;
      }
      if (paramInt1 == 516)
      {
        localIntent.setClassName(this, "com.goertek.factorytest.camera.CameraTest");
        i = 64;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.mGPS.start();
    Intent localIntent = new Intent();
    localIntent.setClassName(this, "com.goertek.factorytest.BatteryLog");
