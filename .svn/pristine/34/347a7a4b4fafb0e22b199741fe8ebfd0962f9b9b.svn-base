...
public class MSensor extends Activity implements SensorEventListener {
	...
	protected void onResume() {
		/*
		 * super.onResume(); this.mSm.registerListener(this, 1, 0);
		 */
		super.onResume();
	...
	public void setDegree(float degree) {
		if (Math.abs(_decDegree - degree) >= 2) {
			...
			if (_decDegree == 90)// (_decDegree > 90 - range && _decDegree <range)//(_decDegree > 90 - range && _decDegree < 90 +
									// range)
			{
			...
			{
				_message = sb.append(getString(R.string.MSensor_north_east)).append(degreeStr)
						.append(getString(R.string.MSensor_degree)).toString();
			}

			if (_decDegree > 90 && _decDegree < 180)// (_decDegree > 135 - range && _decDegree < 135 + range)
			{
				_message = sb.append(getString(R.string.MSensor_south_east)).append(degreeStr)
						.append(getString(R.string.MSensor_degree)).toString();
				;
			}
			...
			{
				_message = sb.append(getString(R.string.MSensor_south_west)).append(degreeStr)
						.append(getString(R.string.MSensor_degree)).toString();
			...
			{
				_message = sb.append(getString(R.string.MSensor_north_west)).append(degreeStr)
						.append(getString(R.string.MSensor_degree)).toString();
			}
	...
	public void onStart() {
		/*
		 * super.onStart(); this.mSm = (SensorManager)getSystemService("sensor");
		 */
	...
	protected void onStop() {
		/*
		 * this.mSm.unregisterListener(this); super.onStop();
		 */
